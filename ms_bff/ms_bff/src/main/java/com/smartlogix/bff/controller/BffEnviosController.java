...
public class BffEnviosController {
    ...
    public ResponseEntity<Object> buscarEnvioPorPedido(@PathVariable("idPedidoRef") String idPedidoRef) {
        Object response = enviosService.buscarEnvioPorPedido(idPedidoRef);
        if (response == null) {
    ...
    public ResponseEntity<List<?>> listarTransportistas() {
        List<?> response = enviosService.listarTransportistasActivos();
        return ResponseEntity.ok(response);
    }

    @GetMapping("/{idEnvio}")
    public ResponseEntity<Object> buscarEnvio(@PathVariable("idEnvio") String idEnvio) {
    ...
    public ResponseEntity<Object> asignarTransportista(
            @PathVariable("idEnvio") String idEnvio,
    ...
    public ResponseEntity<List<?>> listarSeguimiento(@PathVariable("idEnvio") String idEnvio) {
